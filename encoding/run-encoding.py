...
def main():
    ...
    fps, file_pattern, idx_start, idx_end, orig_res = [24, "sintel_2sec00{}", 30, 30, (4096, 1744)]
    ...
    bitrate, width, height = [200, 320, 180]#(200, 320, 180),(1500, 1024, 576),(3000, 1280, 720),(6500, 2560, 1440),(12000, 3840, 2160),(20000, 3840, 2160)
